...
import mate
from examples.hrl.ippo.camera.config import config as _config
from examples.hrl.ippo.camera.config import make_env as _make_env
from examples.hrl.wrappers import HierarchicalCamera
from examples.utils import RLlibPolicyMixIn


class HRLIPPOCameraAgent(RLlibPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical IPPO Camera Agent
