...
import mate
from examples.hrl.qmix.camera.config import config as _config
from examples.hrl.qmix.camera.config import make_env as _make_env
from examples.hrl.wrappers import HierarchicalCamera, MultiDiscrete2DiscreteActionMapper
from examples.utils import RLlibGroupedPolicyMixIn


class HRLQMIXCameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical QMIX Camera Agent
    ...
    def reset(self, observation):
        ...
        if self.multi_selection:
            ...
            self.action_mapper = MultiDiscrete2DiscreteActionMapper(original_space=original_space)
